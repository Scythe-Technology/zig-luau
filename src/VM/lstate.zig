...
pub const lua_State = extern struct {
    ...
    pub const isinteger64 = lapi.isinteger64;
    ...
    pub const tointeger64 = lapi.tointeger64;
    ...
    pub const pushinteger64 = lapi.pushinteger64;
    ...
    pub const rawgetglobal = lapi.rawgetglobal;
    pub const rawget = lapi.rawget;
    pub const rawgeti = lapi.rawgeti;
    pub const getref = lapi.getref;
    ...
    pub const rawsetglobal = lapi.rawsetglobal;
    ...
    pub const Lcheckinteger64 = laux.Lcheckinteger64;
    pub const Loptinteger64 = laux.Loptinteger64;
    ...
    pub const Zpushclosure = zapi.Zpushclosure;
    pub const Zpushclosurek = zapi.Zpushclosurek;
    pub const ZpushfunctionV = zapi.ZpushfunctionV;
    pub const Zpushvalue = zapi.Zpushvalue;
    pub const Zsetfield = zapi.Zsetfield;
    pub const Zsetfieldfn = zapi.Zsetfieldfn;
    pub const ZsetfieldfnV = zapi.ZsetfieldfnV;
    pub const Zsetglobal = zapi.Zsetglobal;
    pub const Zsetglobalfn = zapi.Zsetglobalfn;
    pub const ZsetglobalfnV = zapi.ZsetglobalfnV;
    ...
    pub const Zchecktype = zapi.Zchecktype;
    pub const Zcheckvalue = zapi.Zcheckvalue;
